          ...
          children: [
            ...
            Row(
              children: [
                ...
                const SizedBox(width: 8),
                Text(
                  '${routine.workoutIds.length} workouts in this routine',
                  style: textTheme.bodyMedium,
                ),
              ],
            ),
            ...
            Text(
              'In the next step, this page will connect to the Routine Runner so you can automatically '
              'go through all exercises in this routine with timers and XP.',
              style: textTheme.bodyMedium,
            ),
            const Spacer(),
              SafeArea(
